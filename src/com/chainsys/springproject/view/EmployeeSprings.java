...
//		Employee emp=EmployeeDao.getEmployeeById(emp_id);
		...
		System.out.println("Employee hired date:"+emp.getHireDate());
		System.out.println("Employee job_id:"+emp.getJobId());
		...
		//	apcontext = new ClassPathXmlApplicationContext("Employee.xml");
            ...
            String id = sc.nextLine();
				...
				try {
					...
					val.checkSalaryLimit(emp_salary);
				} catch (InvalidInputDataException e) {
